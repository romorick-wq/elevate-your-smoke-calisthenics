...
assert.ok(indexHtml.includes('shouldRetryReport'));
assert.ok(indexHtml.includes('res.ok===false'));
assert.ok(indexHtml.includes('Skip move'));
assert.ok(!indexHtml.includes("Done \\u2192"));
assert.ok(indexHtml.includes('primaryCtaLabel') || indexHtml.includes('Go to active'));
assert.ok(indexHtml.includes('challengeLive'));
assert.ok(indexHtml.includes('Workout locked until kickoff') || indexHtml.includes('Sign up only'));
...
assert.ok(site.includes('Lock callsign'));
...
assert.ok(site.includes('id="continue"'));
assert.ok(site.includes('Continue training'));
assert.ok(site.includes('smoke30:v1'));
assert.ok(site.includes('/app#login'));
assert.ok(indexHtml.includes('Continue training'));
assert.ok(indexHtml.includes('Log in on this device'));
assert.ok(indexHtml.includes('/api/me/login'));
assert.ok(indexHtml.includes('function loginScreen'));
assert.ok(!indexHtml.includes('pin_hash'));
...
assert.ok(dbJs.includes('pin_hash'));
assert.ok(dbJs.includes('card_json'));
assert.ok(dbJs.includes('loginMember'));
assert.ok(dbJs.includes('setMemberPin'));
assert.ok(serverJs.includes("'/api/me/login'"));
assert.ok(serverJs.includes("'/api/me/pin'"));
assert.ok(serverJs.includes('handleMeLogin'));
